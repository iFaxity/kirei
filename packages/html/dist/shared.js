...
const udomdiff_1 = require("udomdiff");
...
function diff(node, oldNodes, newNodes) {
    ...
    return udomdiff_1.default(node.parentNode, oldNodes, newNodes, diffable, node);
}
exports.diff = diff;
