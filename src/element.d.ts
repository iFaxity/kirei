...
export declare type LitTemplate = (strings: any, ...values: any[]) => TemplateResult;
export declare const html: (strings: any, ...values: any[]) => TemplateResult;
export declare const svg: (strings: any, ...values: any[]) => TemplateResult;
...
export declare class FxElement extends HTMLElement {
     ...
     */
    _callHooks(hook: string): void;
    /**
     * Schedules a run to render updated content
     */
    _scheduleRender(run: () => void): void;
    /**
